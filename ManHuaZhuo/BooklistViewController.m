...
-(void)loadView
{
    ...
    if (IOS7) {
        hotBooklistVController=[[CommonBooklistViewController alloc] initWitCatalog:catalog frame:CGRectMake(0, 64, self.view.frame.size.width, self.view.frame.size.height-32-44-24) order:OrderTypeHot state:BookStateAll];
