...
- (void)viewDidLoad
{
    ...
    if (IOS7) {
        movingView=[[TPKeyboardAvoidingScrollView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
    ...
    if (IOS7) {
        ...
        [btnRegister setFrame:CGRectMake((self.view.frame.size.width-135)/2, 400, 135, 40)];
